...
class strategy_two(Strategy):
    ...
    def move_action_decision(self, game_state: GameState, my_player_index: int) -> Position:
        position, _ = player_two_strategy(game_state, my_player_index)
        return position

    def attack_action_decision(self, game_state: GameState, my_player_index: int) -> int:
        _, attack = player_two_strategy(game_state, my_player_index)
        return attack
...
def player_two_strategy(game_state: GameState, my_player_index: int):
