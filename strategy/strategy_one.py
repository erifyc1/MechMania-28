...
class strategy_one(Strategy):
    ...
    def move_action_decision(self, game_state: GameState, my_player_index: int) -> Position:
        position, _ = player_one_strategy(game_state, my_player_index)
        return position

    def attack_action_decision(self, game_state: GameState, my_player_index: int) -> int:
        _, attack = player_one_strategy(game_state, my_player_index)
        return attack
...
def player_one_strategy(game_state: GameState, my_player_index: int):
